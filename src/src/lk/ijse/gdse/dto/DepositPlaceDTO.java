...
public class DepositPlaceDTO {
    ...
    public DepositPlaceDTO(String deposit_Id, String saving_Account_No, double amount, String date, String time, ArrayList<Account> accounts) {
