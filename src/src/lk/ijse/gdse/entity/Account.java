...
public class Account implements SuperEntity {
    ...
    public Account(String member_Id,String saving_Account_No, String name, String nic, String gender, String address, String mobile, String email, String date_of_birth, String creat_Date, String creat_Time, double saving_Balance,String branch_No) {
