...
public class LoanDeposit implements SuperEntity{
...
private String time;
    ...
    public LoanDeposit(String deposit_loan_Id, double deposit_Loan_amount, String loan_Id, String date, String time ) {
